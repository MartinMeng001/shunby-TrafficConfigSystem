...
public class SegmentVehicleEventTestFeature {
    ...
    public Map<String, Object> triggerSegment1UpstreamEnter() {
        return triggerVehicleEvent(1, SegmentEvent.VEHICLE_ENTER_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment1UpstreamExit() {
        return triggerVehicleEvent(1, SegmentEvent.VEHICLE_EXIT_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment2UpstreamEnter() {
        return triggerVehicleEvent(2, SegmentEvent.VEHICLE_ENTER_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment2UpstreamExit() {
        return triggerVehicleEvent(2, SegmentEvent.VEHICLE_EXIT_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment3UpstreamEnter() {
        return triggerVehicleEvent(3, SegmentEvent.VEHICLE_ENTER_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment3UpstreamExit() {
        return triggerVehicleEvent(3, SegmentEvent.VEHICLE_EXIT_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment4UpstreamEnter() {
        return triggerVehicleEvent(4, SegmentEvent.VEHICLE_ENTER_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment4UpstreamExit() {
        return triggerVehicleEvent(4, SegmentEvent.VEHICLE_EXIT_UPSTREAM, TEST_LICENSE_PLATE_1);
    }
    ...
    public Map<String, Object> triggerSegment1DownstreamEnter() {
        return triggerVehicleEvent(1, SegmentEvent.VEHICLE_ENTER_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment1DownstreamExit() {
        return triggerVehicleEvent(1, SegmentEvent.VEHICLE_EXIT_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment2DownstreamEnter() {
        return triggerVehicleEvent(2, SegmentEvent.VEHICLE_ENTER_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment2DownstreamExit() {
        return triggerVehicleEvent(2, SegmentEvent.VEHICLE_EXIT_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment3DownstreamEnter() {
        return triggerVehicleEvent(3, SegmentEvent.VEHICLE_ENTER_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment3DownstreamExit() {
        return triggerVehicleEvent(3, SegmentEvent.VEHICLE_EXIT_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment4DownstreamEnter() {
        return triggerVehicleEvent(4, SegmentEvent.VEHICLE_ENTER_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    public Map<String, Object> triggerSegment4DownstreamExit() {
        return triggerVehicleEvent(4, SegmentEvent.VEHICLE_EXIT_DOWNSTREAM, TEST_LICENSE_PLATE_2);
    }
    ...
    /**
     * 通用的车辆事件触发方法
     * 基于 SegmentStateMachineV3Service.processSegmentEventAsync 实现
     */
    private Map<String, Object> triggerVehicleEvent(int segmentId, SegmentEvent event, String licensePlate) {
        try {
            // 准备事件数据
            Map<String, Object> eventData = createEventData(licensePlate);
            if(licensePlate.equalsIgnoreCase(TEST_LICENSE_PLATE_1))
            ...
            eventData.put("vehicleId", licensePlate);
            ...
            // 记录事件历史
            recordEventHistory(segmentId, event, licensePlate);
            ...
            logger.info("手动触发车辆事件 - 路段{} {} 车牌{}",
                    segmentId, event.getChineseName(), licensePlate);

            return response;

        } catch (Exception e) {
            logger.error("触发车辆事件失败 - 路段{} {} 车牌{}: {}",
                    segmentId, event.getChineseName(), licensePlate, e.getMessage(), e);
            ...
            errorResponse.put("licensePlate", licensePlate);
